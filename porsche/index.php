<?php
	...
	if(isset($_SESSION['user_id'])) {
		$id = $_POST["id"];
		if(!empty($id)){
			$query = "SELECT * FROM porsche WHERE id='$id'";
...
<a href="/automobiles/cart.php">
	...
	<h1 id="headertext" class="text-center text-info">Porsche catalog</h1>
	<div class="container-fluid">
		<div class="container" id="catalog">
			<?php 
			$query = "SELECT * FROM porsche ORDER BY id ASC";
			...
			<div class="col-4" id="types">
				...
				<h2 class="text-info text-center">Porsche <?php echo "<pre style='overflow:hidden;' class='text-info'>".$row["type"]."</pre>"; ?></h2><hr>
