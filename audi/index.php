<?php
	...
	if(isset($_SESSION['user_id'])) {
		$id = $_POST["id"];
		if(!empty($id)){
			$query = "SELECT * FROM audi WHERE id='$id'";
...
<a href="/automobiles/cart.php">  
	...
	<h1 id="headertext" class="text-center text-info">Audi catalog</h1>
	<div class="container-fluid">
		<div class="container" id="catalog">
			<?php 
			$query = "SELECT * FROM audi ORDER BY id ASC";
			...
			<div class="col-4" id="types">
				...
				<h2 class="text-info text-center">Audi <?php echo $row["type"]; ?></h2><hr>
