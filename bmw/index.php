<?php
	...
	if(isset($_SESSION['user_id'])) {
		$id = $_POST["id"];
		if(!empty($id)){
			$query = "SELECT * FROM bmw WHERE id='$id'";
...
</a><a href="/index.php" class="text-primary" id="back">Go back</a>
<a href="/automobiles/" class="text-primary" id="back">Go back</a>
<h1 id="headertext" class="text-center text-info">BMW catalog</h1>
	<div class="container-fluid">	
		<div class="container" id="catalog">
			<?php 
			$query = "SELECT * FROM bmw ORDER BY id ASC";
			...
			<div class="col-4" id="types">
				...
				<h2 class="text-info text-center">BMW <?php echo $row["type"]; ?></h2><hr>
