<?php
	...
	if(isset($_SESSION['user_id'])) {
		$id = $_POST["id"];
		if(!empty($id)){
			$query = "SELECT * FROM mercedes WHERE id='$id'";
...
<a href="/automobiles/cart.php">
	...
	<h1 id="headertext" class="text-center text-info">Mercedes catalog</h1>
	<div class="container-fluid">
		<div class="container" id="catalog">
			<?php 
			$query = "SELECT * FROM mercedes ORDER BY id ASC";
			...
			<div class="col-4" id="types">
				...
				<h2 class="text-info text-center">Mercedes <?php echo "<pre class='text-info'> ".$row["type"]."</pre>"; ?> </h2><hr>
